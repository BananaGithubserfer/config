...
export declare function formatBladeString(text: string): string;
export declare function setOptions(options: ParserOptions): void;
export declare function formatAsHtml(text: string): string;
export declare function inlineFormatPhp(text: string): string;
export declare function formatPhp(text: string): string;
export declare function formatTagPhp(text: string): string;
